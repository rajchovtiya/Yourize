    ...
    return (
        <footer className="bg-black text-gray-300 px-6 py-12 mt-14">
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center md:text-left">
                ...
                <div>
                    <NavLink to='/'>
                        <img src="/img/Logo (2).png" alt="Logo" className="w-36 mb-4 mx-auto md:mx-0 cursor-pointer" />
                    </NavLink>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><NavLink to="/Pricing" className="hover:text-yellow-400 transition">Pricing</NavLink></li>
