        ...
        <section className="bg-black text-white py-20 px-4 md:px-10 relative overflow-hidden h-auto">
            ...
            <div className="relative max-w-7xl mx-auto text-center">
                ...
                <div className="relative w-full rounded-[50px]">
                    <div className="w-full bg-[#FAC817] opacity-30 blur-3xl xl:blur-sm rounded-[50px] h-full absolute top-0"></div>

                    <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
                        {/* Box 1 */}
                        <div className="border-2 border-[#FAC817] rounded-2xl flex flex-col items-center lg:items-start justify-center bg-black px-8 py-10 h-[300px]">
